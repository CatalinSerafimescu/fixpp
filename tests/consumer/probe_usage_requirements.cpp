...
// consumer through fixpp_capi_objects -> fixpp_log (src/capi/CMakeLists.txt's fixpp_capi_objects
// PUBLIC link) and never appear in fixpp::capi's block, which reads IDENTICALLY whether they
