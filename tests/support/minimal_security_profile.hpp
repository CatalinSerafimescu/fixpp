...
//
// Test-only helper: returns a minimal fixpp::tls::SecurityProfile that
// satisfies Session::open()'s no-implicit-default sentinel rejection
// (FR-018 / N-P2-3 / [const §XII.5] / gate-b/r1 RC#1).
//
...
[[nodiscard]] inline fixpp::tls::SecurityProfile make_minimal_security_profile() {
    return fixpp::tls::SecurityProfile{fixpp::tls::SecurityProfile::kind::mtls_ca};
}
