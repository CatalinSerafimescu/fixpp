...
int main() {
    FIX44::ExecutionReport er(FIX::OrderID("ORD-XCH-001"), FIX::ExecID("EXEC-001"),
                              FIX::ExecType(FIX::ExecType_TRADE),
                              FIX::OrdStatus(FIX::OrdStatus_FILLED), FIX::Side(FIX::Side_BUY),
                              FIX::LeavesQty(0), FIX::CumQty(100), FIX::AvgPx(190.5));
