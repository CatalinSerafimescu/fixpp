...
// TradeCaptureReport (35=AE) required fields (dictionaries/FIX44.xml's TradeCaptureReport message
// declaration): TradeReportID(571), PreviouslyReported(570), LastQty(32), LastPx(31),
// TradeDate(75), TransactTime(60), and the TrdCapRptSideGrp NoSides(552) group (required, >=1
// entry; entry-level Side(54)/OrderID(37) required, dictionaries/FIX44.xml's TrdCapRptSideGrp
// NoSides group).
