...
// while the primitive's own twin stays green. Same for
// ZeroBudgetProbeCanNowResumeACoroutine, ThrowingHandlerReportsOnceNotTwice and
// OuterCatchSwallowsAThrowingAddFailure below.
