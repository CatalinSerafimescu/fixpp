...
| `/analyze` | ⚠️ **OWED.** It is a cross-artifact check over `spec.md` / `plan.md` / `tasks.md` and becomes runnable only once this file exists — scheduled at T084 |
...
- [ ] T084 Run `/speckit-analyze` over `spec.md`, `plan.md` and this file in `specs/090-capi-refusals/`. ⚠️ **It is OWED, NOT discharged** — a plan entry claimed otherwise until 2026-09-20 and that claim was **FALSE; do not restate it**. It could not run before this file existed. ⚠️ Expect it to flag the `/plan` sign-off divergence this file's header block records between `plan.md` and `spec.md` / `data-model.md` / `quickstart.md`.
