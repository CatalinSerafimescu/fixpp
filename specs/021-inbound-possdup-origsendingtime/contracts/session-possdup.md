...
| `43=Y`, `122` **missing** (non-`35=4`, any seqnum incl. `34==N`) | `Reject(35=3)`, `371=122`, `373=1` (RequiredTagMissing) | stays `Active`; expected stays `N` (no advance — verify-returns-false, QFJ `Session.java:1843`) **[at-expected no-advance SUPERSEDED 2026-09-14 by fixpp#423 — see B-423-1]** |
| `43=Y`, `122` **present but unparseable** (non-`35=4`, any seqnum incl. `34==N`) | `Reject(35=3)`, `371=122`, `373=1` (RequiredTagMissing) — same as absent `122` | stays `Active`; expected stays `N` (gate-b/r1) **[at-expected no-advance SUPERSEDED 2026-09-14 by fixpp#423 — see B-423-1]** |
