...
| SC-016 *(new)* | validation and typed read agree on instance count **and boundaries**, and the extent spans all instances, for the delimiter-is-a-nested-count shape — the **262** contexts for which SC-010 was unachievable as scoped through round 2 | spec SC-016, `typed_read_splitter.md` **W-10a**, plan Phase-4 gate, quickstart §2a/§4 |
