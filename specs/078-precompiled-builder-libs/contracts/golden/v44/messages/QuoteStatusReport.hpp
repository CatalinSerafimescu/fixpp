...
// fixpp/v44/messages/QuoteStatusReport.hpp -- slim per-message declaration header (data-model.md Entity 2).
#pragma once
...
struct QuoteStatusReportArgs {
    ...
    ::std::optional<::std::span<const groups::G_555_6Args>> legs{};
