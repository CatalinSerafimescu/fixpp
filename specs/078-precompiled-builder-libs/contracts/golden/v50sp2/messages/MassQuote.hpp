...
// fixpp/v50sp2/messages/MassQuote.hpp -- slim per-message declaration header (data-model.md Entity 2).
#pragma once
...
struct MassQuoteArgs {
    ...
    ::std::optional<::std::span<const groups::G_296_2Args>> quote_sets{};
