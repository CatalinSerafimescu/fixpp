...
// fixpp/v50sp2/messages/MassOrder.hpp -- slim per-message declaration header (data-model.md Entity 2).
#pragma once
...
struct MassOrderArgs {
    ...
    ::std::optional<::std::span<const groups::G_2428_1Args>> order_entries{};
