...
// fixpp/v50sp2/groups/G_41096Args.hpp -- one shared repeating-group Args struct (data-model.md Entity 1); DATA-ONLY, no validator traits; includes only this plan's direct child group headers.
#pragma once
#include <cstdint>
...
struct G_41096Args {
    ::std::optional<::std::int64_t> market_disruption_fallback_underlier_type{};
    ...
    ::std::optional<::fixpp::decimal_t> market_disruption_fallback_basket_divisor{};
};
