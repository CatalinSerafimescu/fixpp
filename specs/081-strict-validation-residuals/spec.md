...
- **SC-002**: Across every dictionary / message / group context, fixpp's per-group required-member set is exact-set-equal to a QuickFIX-derived oracle in both directions — 0 divergences (down from the 24 strict-superset contexts).
