...
- FR-002's census is intentionally open-ended (find all reused-with-differing-membership tags) — bounded by "across the shipped FIX44/FIX42/FIX50SP2 dictionaries" and made concrete at plan/implement time; not a [NEEDS CLARIFICATION].
