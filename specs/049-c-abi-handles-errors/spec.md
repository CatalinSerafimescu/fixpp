...
- **Constitution Article IX** (`.specify/constitution.md`) — per-PR ≥95% line / ≥85% branch coverage + ASan/UBSan/TSan on the touched modules (the 116-arm `translate()` switch + the `strerror` table are the coverage surface).
