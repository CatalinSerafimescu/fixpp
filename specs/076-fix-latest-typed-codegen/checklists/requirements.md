...
- **"All mandatory sections completed" (Content Quality) — now legitimately [x] after Gate A round 1:** the constitutionally-required `## Normative References` section (Article VI §5) was added to `spec.md` (citing A-035..A-065, D-011, EP303, and the FIXT.1.1/5.0SP2 wire base). Before that rewrite this item was a false certification (the section was missing) — it passes truthfully only as of the round-1 convergence rewrite.
