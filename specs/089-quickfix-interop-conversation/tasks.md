...
- [ ] T057a [US3] Correct `library/spec/behaviors-and-limitations.md` L-067-2 to the guard's real range (`0x20–0x7E`: no non-ASCII content, not only no control bytes), citing fixpp #418; the limitation stays open (plan.md § *External obligations*). ⚠️ **Id note**: `a`-suffixed on this bundle's own idiom (see T002a) — added 2026-09-11 implement
