...
4. **Given** the recorded dict-free trailing-field false positive, **When** a reader asks what is being done about it, **Then** the row cites an open GitHub issue number — not a promise in prose, which is the failure mode that orphaned this row's own leg 2.
