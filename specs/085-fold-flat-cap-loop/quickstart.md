...
| §0's structural pin **green** on the unmodified tree | The pin is not discriminating — it would be green from birth, which discharges nothing (SC-005b). Check the discriminant against §0's measured counts (4-space `inst_start` = 1, 8-space = 0 at `c1564dd2`) before suspecting the build |
