...
|---|---|---|
| Authorize Logon gate (acceptor) | three-way guard: (1) override→authorize; (2) `else if (is_mtls)`→fail-CLOSED (emit `compid_authorization_failed`+Disconnected); (3) non-mTLS→skip | `src/session/session.cpp:953-1008` |
