...
- **Polish (Phase 8)**: depends on all user stories. T072 (coverage) depends on T070 (sanitizer pass) being clean and all seams green.
...
- Polish: T068 is [P] (own test file); T069–T077 sequence around the verify gate.
