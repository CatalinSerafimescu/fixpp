...
//
// fixpp::session::retrieve_visitor — awaitable per-frame walker for
// MessageStore::retrieve(). Entity E2; FR-004.
//
// Anchor: .specify/2e-msgstore.md v0.5 §4.5.
//
...
//
// Mirror of specs/008-message-store/contracts/retrieve_visitor.hpp.
#pragma once
...
public:
    ...
    [[nodiscard]] virtual asio::awaitable<fixpp::core::expected_t<visit_result>> on_frame(
        seqnum_t seq, std::span<const std::byte> frame [[clang::lifetimebound]]) noexcept = 0;
