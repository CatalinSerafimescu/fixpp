...
//
// Design anchor: .specify/2g-tls.md v0.4 §4.5's `struct peer_identity` block (verbatim).
...
struct peer_identity {
    ...
    // Field shape mirrors 2g §4.5's `struct peer_identity` fields verbatim.
    ...
    // (2g §4.5's `peer_identity` accessor declarations, verbatim.)
