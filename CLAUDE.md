<!-- SPECKIT START -->
**Active feature:** none — `027-next-expected-msgseqnum` MERGED 2026-06-07 (PR #108 squash `6aecf64`, gate-b-done). Next = remaining G3 (CheckCompID / validateSequenceNumbers / MaxLatency config knobs, C-103) → **025-refresh-on-logon** G3 capstone (parked on T034 inbound-store-persistence, [[project_025_refresh_on_logon_bundling_plan]]) → G4. Per [[project_release_interop_quickfix_fix8]].
