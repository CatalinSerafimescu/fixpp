...
declare -A EXPECTED=(
  ...
  # Session/app + message-construction block [1400,1499] — Phase-4-owned (051
  # [2i §4.3] amendment). Published surface → Check A only (NOT Check B's
  # source-domain counts; the [0,99] count + prior-doc 97 total are unchanged).
  [FIXPP_ERR_SESSION_INVALID_ARGUMENT]=1400 [FIXPP_ERR_SESSION_INVALID_STATE]=1401
  [FIXPP_ERR_APP_DO_NOT_SEND]=1402 [FIXPP_ERR_APP_CALLBACK_THREW]=1403
  [FIXPP_ERR_APP_PAYLOAD_MALFORMED]=1404 [FIXPP_ERR_MSG_FRAMING_TAG_FORBIDDEN]=1405
)
