...
// contracts/security_profile.hpp's binding contract "caps.X is shorthand for
...
#pragma GCC diagnostic pop
    ...
    // CONTRACT (re-emitted at contracts/security_profile.hpp's pinning-consumption note), the
