...
core::expected_t<application_version>
resolve_application_version(version_profile profile,
    ...
    if (appl_ver_id_value.size() == 1) {
        switch (appl_ver_id_value.front()) {
            case '2': return application_version::v40;     // FIX 4.0
            case '3': return application_version::v41;     // FIX 4.1
            case '4': return application_version::v42;     // FIX 4.2
            case '5': return application_version::v43;     // FIX 4.3
            case '6': return application_version::v44;     // FIX 4.4
            case '7': return application_version::v50;     // FIX 5.0
            case '8': return application_version::v50sp1;  // FIX 5.0 SP1
            case '9': return application_version::v50sp2;  // FIX 5.0 SP2
            default: break;  // '0'/'1' (pre-4.0/unused) and any other → reject
        }
    }
