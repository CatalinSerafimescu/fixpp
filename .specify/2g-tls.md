...
public:
    struct Config {
        ...
        // every snapshot Pinset::snapshot() ever returns, NOT merely the
        // Pinset itself. The §6.5 binding contract permits a reader to hold
