...
- The gcc presets keep `FIXPP_WERROR=OFF`; that preset decision was left as it was.
...
govern — pair every marker against the base after one. `clang-tidy -fix` at scale is not
