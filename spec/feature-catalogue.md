...
| ID | Source | Category | Title | FIX version(s) | Spec ref | Status | /specify | PR | Tests | Verified |
|---|---|---|---|---|---|---|---|---|---|---|
| W-001 | OFFICIAL | wire | Tag=Value (field) encoding — ASCII digit tag, '=' separator, SOH delimiter | 4.0–5.0SP2, FIXT.1.1 | [FIX50SP2 §3] Tag=Value encoding | done | 004-wire-codec | #68 | `tests/wire/parser_index_test.cpp`, `parser_iter_test.cpp`, `conformance/w001_*.csv` | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
...
| W-003 | OFFICIAL | wire | Standard trailer fields — CheckSum(10), mandatory last field | 4.0–5.0SP2, FIXT.1.1 | [FIX50SP2 §3.1] Standard trailer | done | 004-wire-codec | #68 | `tests/wire/parser_index_test.cpp`, `conformance/w003_*.csv` | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
| W-004 | OFFICIAL | wire | BodyLength(9) computation — byte count from MsgType(35) to delimiter before CheckSum(10) | 4.0–5.0SP2, FIXT.1.1 | [FIX50SP2 §3.1] Standard header | done | 004-wire-codec | #68 | `tests/wire/round_trip_property_test.cpp`, `conformance/w004_*.csv` | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
| W-005 | OFFICIAL | wire | CheckSum(10) computation — sum of all bytes mod 256, formatted as 3-digit zero-padded ASCII | 4.0–5.0SP2, FIXT.1.1 | [FIX50SP2 §3.1] Standard header | done | 004-wire-codec | #68 | `tests/wire/round_trip_property_test.cpp`, `checksum_bodylength_corruption_test.cpp`, `conformance/w005_*.csv` | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
...
| W-008 | OFFICIAL | wire | Data (raw bytes) field type — Length tag + Data tag pair (e.g., RawDataLength/RawData) | 4.0–5.0SP2 | [FIX50SP2 §3.3] Field data types | done | 004-wire-codec | #68 | `tests/wire/parser_index_test.cpp`, `parser_iter_test.cpp`, `conformance/w008_*.csv` | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
| W-009 | OFFICIAL | wire | Field data types — INT, FLOAT, CHAR, BOOLEAN, STRING, MULTIPLECHARVALUE, MULTIPLEVALUESTRING, CURRENCY, EXCHANGE, MONTHYEAR, UTCTIMESTAMP, UTCTIMEONLY, UTCDATEONLY, LOCALMKTDATE, TZTIMEONLY, TZTIMESTAMP, LENGTH, SEQNUM, NUMINGROUP, COUNTRY, LANGUAGE, XMLDATA | 4.0–5.0SP2 | [FIX50SP2 §3.3] Field data types | done | 001-core-decimal → 004-wire-codec | #62 → #68 | FLOAT primitive landed #62; wire FLOAT-accessor leg landed in 004 (`tests/wire/cutover_2b_gated_test.cpp`, `conformance/w009_*.csv`) — 2b deferral closed by T027 | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
| W-010 | OFFICIAL | wire | Pipelined message framing — multiple messages on one TCP stream | 4.0–5.0SP2, FIXT.1.1 | [FIX50SP2 §3] Tag=Value encoding | done | 004-wire-codec | #68 | `tests/wire/framer_partial_read_test.cpp`, `conformance/w010_*.csv` | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
| W-011 | OFFICIAL | wire | Zero-copy parser — tag/value views into a contiguous buffer without allocation | 4.0–5.0SP2 | [impl] implementation NFR | done | 004-wire-codec | #68 | `tests/wire/three_arena_pinning_test.cpp`, `tests/alloc_guard/wire_alloc_guard_test.cpp` | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
| W-012 | OFFICIAL | wire | Offset-table parser approach — index tags by position, O(1) field lookup | 4.0–5.0SP2 | [impl] implementation NFR | done | 004-wire-codec | #68 | `tests/wire/offset_table_test.cpp`, `conformance/w012_*.csv` | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
| W-013 | OFFICIAL | wire | Message serializer — write fields in required order, compute BodyLength and CheckSum on the fly | 4.0–5.0SP2, FIXT.1.1 | [FIX50SP2 §3.1] Standard header | done | 004-wire-codec | #68 | `tests/wire/round_trip_property_test.cpp`, `writer_error_path_test.cpp`, `conformance/w013_*.csv` | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
...
| OSS-006 | OSS:hffix | wire | Header-only zero-copy parser — single translation unit, no heap allocation in hot path | 4.0–5.0SP2 | hffix include/hffix.hpp | done | 004-wire-codec | #68 | `tests/wire/parser_index_test.cpp`, `parser_iter_test.cpp`, `tests/alloc_guard/wire_alloc_guard_test.cpp` | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
...
| OSS-008 | OSS:hffix | wire | message_writer over caller-supplied buffer — serializer takes external storage | 4.0–5.0SP2 | hffix | done | 004-wire-codec | #68 | `tests/wire/round_trip_property_test.cpp`, `writer_error_path_test.cpp` | Gate A converged r1; Gate B PR #68 (converging via gate-b loop) |
