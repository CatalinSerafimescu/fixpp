...
- **Not addressed by #419, tracked separately:** the replayed frame's own `SendingTime(52)` is copied byte-for-byte from the stored value, never restamped to the retransmission time. → **fixpp#420**.
