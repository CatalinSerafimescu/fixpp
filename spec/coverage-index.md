...
| S-016 §6.2/§6.1 catalogue rows above carry the 005-scope deferral note; the S-001..S-020 rows 005 owns are the FIX.4.2/4.4 point-to-point establishment slice only, not their full version span. | | | |
